...
# 放开注释更改不同层数
model = TransformerModel(num_encoder_layers=8).to(device)
...
torch.save(model.state_dict(), 'transformer_deep_model.pth')
...
plt.tight_layout()
plt.savefig('transformer_8_8_loss_and_accuracy.png')
# plt.show()